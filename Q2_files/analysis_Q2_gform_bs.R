...
cinc.nevertrt.mace.gform.bs<-matrix(nrow=nboot,ncol=length(time.grid))
...
cinc.nevertrt.death.gform.bs<-matrix(nrow=nboot,ncol=length(time.grid))

diff.A.mace.gform.bs<-matrix(nrow=nboot,ncol=length(time.grid))
...
diff.A.death.gform.bs<-matrix(nrow=nboot,ncol=length(time.grid))
...
for(b in 1:nboot){
  ...
  cinc.nevertrt.mace.gform.bs[b,]<-cincstep.nevertrt.mace.gform(time.grid)
  ...
  cinc.nevertrt.death.gform.bs[b,]<-cincstep.nevertrt.death.gform(time.grid)
  
  #obtain effect estimates
  
  diff.A.mace.gform.bs[b,]<-cinc.A.mace.gform-cinc.nevertrt.mace.gform
  diff.B.mace.gform.bs[b,]<-cinc.B.mace.gform-cinc.nevertrt.mace.gform
  diff.C.mace.gform.bs[b,]<-cinc.C.mace.gform-cinc.nevertrt.mace.gform
  diff.D.mace.gform.bs[b,]<-cinc.D.mace.gform-cinc.nevertrt.mace.gform
  
  diff.A.death.gform.bs[b,]<-cinc.A.death.gform-cinc.nevertrt.death.gform
  diff.B.death.gform.bs[b,]<-cinc.B.death.gform-cinc.nevertrt.death.gform
  diff.C.death.gform.bs[b,]<-cinc.C.death.gform-cinc.nevertrt.death.gform
  diff.D.death.gform.bs[b,]<-cinc.D.death.gform-cinc.nevertrt.death.gform
...
cinc.nevertrt.mace.gform.CIL<-sapply(1:length(time.grid),FUN=function(x){quantile(cinc.nevertrt.mace.gform.bs[,x],0.05)})
...
cinc.nevertrt.mace.gform.CIU<-sapply(1:length(time.grid),FUN=function(x){quantile(cinc.nevertrt.mace.gform.bs[,x],0.95)})
...
cinc.nevertrt.death.gform.CIL<-sapply(1:length(time.grid),FUN=function(x){quantile(cinc.nevertrt.death.gform.bs[,x],0.05)})
...
cinc.nevertrt.death.gform.CIU<-sapply(1:length(time.grid),FUN=function(x){quantile(cinc.nevertrt.death.gform.bs[,x],0.95)})

diff.A.mace.gform.CIL<-sapply(1:length(time.grid),FUN=function(x){quantile(diff.A.mace.gform.bs[,x],0.05)})
...
diff.A.mace.gform.CIU<-sapply(1:length(time.grid),FUN=function(x){quantile(diff.A.mace.gform.bs[,x],0.95)})
...
diff.A.death.gform.CIL<-sapply(1:length(time.grid),FUN=function(x){quantile(diff.A.death.gform.bs[,x],0.05)})
...
diff.A.death.gform.CIU<-sapply(1:length(time.grid),FUN=function(x){quantile(diff.A.death.gform.bs[,x],0.95)})
