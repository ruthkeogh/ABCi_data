...
cinc.nevertrt.mace.iptw<-cincstep.nevertrt.mace.iptw(time.grid)
...
cinc.nevertrt.death.iptw<-cincstep.nevertrt.mace.iptw(time.grid)

#obtain effect estimates: treatment vs never treat

diff.A.mace.iptw<-cinc.A.mace.iptw-cinc.nevertrt.mace.iptw
diff.B.mace.iptw<-cinc.B.mace.iptw-cinc.nevertrt.mace.iptw
diff.C.mace.iptw<-cinc.C.mace.iptw-cinc.nevertrt.mace.iptw
diff.D.mace.iptw<-cinc.D.mace.iptw-cinc.nevertrt.mace.iptw

diff.A.death.iptw<-cinc.A.death.iptw-cinc.nevertrt.death.iptw
diff.B.death.iptw<-cinc.B.death.iptw-cinc.nevertrt.death.iptw
diff.C.death.iptw<-cinc.C.death.iptw-cinc.nevertrt.death.iptw
diff.D.death.iptw<-cinc.D.death.iptw-cinc.nevertrt.death.iptw
