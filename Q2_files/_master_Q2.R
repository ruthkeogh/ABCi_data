...
#
#This master file for Q2 runs the following analyses:
#(i) Naive analysis, (ii) IPTW, (iii) g-formula
#It also generates the true cumulative incidences under the 5 treatment strategies. 
...
source("functions/function_bootstrap_cluster.R")
...
source("datasetup_Q2.R")

#estimates and 95% CIs
source("analysis_Q2_naive.R")
...
#estimates
source("analysis_Q2_IPTW.R")

#bootstrap to get 95% CIs
source("analysis_Q2_IPTW_bs.R")
...
#estimates
source("analysis_Q2_gform.R")

#bootstrap to get 95% CIs
source("analysis_Q2_gform_bs.R")

#------------------------------------------------------
#Obtain true values
#------------------------------------------------------

source("analysis_Q2_TRUTH.R")
...
plot.dta.mace<-data.frame(
  time.grid,
  #true
  cinc.A.mace.true,cinc.B.mace.true,cinc.C.mace.true,cinc.D.mace.true,cinc.nevertrt.mace.true,
  cinc.A.mace.true.CIL,cinc.B.mace.true.CIL,cinc.C.mace.true.CIL,cinc.D.mace.true.CIL,cinc.nevertrt.mace.true.CIL,
  cinc.A.mace.true.CIU,cinc.B.mace.true.CIU,cinc.C.mace.true.CIU,cinc.D.mace.true.CIU,cinc.nevertrt.mace.true.CIU,
  #naive
  cinc.A.mace.naive,cinc.B.mace.naive,cinc.C.mace.naive,cinc.D.mace.naive,cinc.nevertrt.mace.naive,
  cinc.A.mace.naive.CIL,cinc.B.mace.naive.CIL,cinc.C.mace.naive.CIL,cinc.D.mace.naive.CIL,cinc.nevertrt.mace.naive.CIL,
  cinc.A.mace.naive.CIU,cinc.B.mace.naive.CIU,cinc.C.mace.naive.CIU,cinc.D.mace.naive.CIU,cinc.nevertrt.mace.naive.CIU,
  #iptw
  cinc.A.mace.iptw,cinc.B.mace.iptw,cinc.C.mace.iptw,cinc.D.mace.iptw,cinc.nevertrt.mace.iptw,
  cinc.A.mace.iptw.CIL,cinc.B.mace.iptw.CIL,cinc.C.mace.iptw.CIL,cinc.D.mace.iptw.CIL,cinc.nevertrt.mace.iptw.CIL,
  cinc.A.mace.iptw.CIU,cinc.B.mace.iptw.CIU,cinc.C.mace.iptw.CIU,cinc.D.mace.iptw.CIU,cinc.nevertrt.mace.iptw.CIU,
  #gformula
  cinc.A.mace.gform,cinc.B.mace.gform,cinc.C.mace.gform,cinc.D.mace.gform,cinc.nevertrt.mace.gform,
  cinc.A.mace.gform.CIL,cinc.B.mace.gform.CIL,cinc.C.mace.gform.CIL,cinc.D.mace.gform.CIL,cinc.nevertrt.mace.gform.CIL,
  cinc.A.mace.gform.CIU,cinc.B.mace.gform.CIU,cinc.C.mace.gform.CIU,cinc.D.mace.gform.CIU,cinc.nevertrt.mace.gform.CIU
)

plot.dta.death<-data.frame(
  time.grid,
  #true
  cinc.A.death.true,cinc.B.death.true,cinc.C.death.true,cinc.D.death.true,cinc.nevertrt.death.true,
  cinc.A.death.true.CIL,cinc.B.death.true.CIL,cinc.C.death.true.CIL,cinc.D.death.true.CIL,cinc.nevertrt.death.true.CIL,
  cinc.A.death.true.CIU,cinc.B.death.true.CIU,cinc.C.death.true.CIU,cinc.D.death.true.CIU,cinc.nevertrt.death.true.CIU,
  #naive
  cinc.A.death.naive,cinc.B.death.naive,cinc.C.death.naive,cinc.D.death.naive,cinc.nevertrt.death.naive,
  cinc.A.death.naive.CIL,cinc.B.death.naive.CIL,cinc.C.death.naive.CIL,cinc.D.death.naive.CIL,cinc.nevertrt.death.naive.CIL,
  cinc.A.death.naive.CIU,cinc.B.death.naive.CIU,cinc.C.death.naive.CIU,cinc.D.death.naive.CIU,cinc.nevertrt.death.naive.CIU,
  #iptw
  cinc.A.death.iptw,cinc.B.death.iptw,cinc.C.death.iptw,cinc.D.death.iptw,cinc.nevertrt.death.iptw,
  cinc.A.death.iptw.CIL,cinc.B.death.iptw.CIL,cinc.C.death.iptw.CIL,cinc.D.death.iptw.CIL,cinc.nevertrt.death.iptw.CIL,
  cinc.A.death.iptw.CIU,cinc.B.death.iptw.CIU,cinc.C.death.iptw.CIU,cinc.D.death.iptw.CIU,cinc.nevertrt.death.iptw.CIU,
  #gformula
  cinc.A.death.gform,cinc.B.death.gform,cinc.C.death.gform,cinc.D.death.gform,cinc.nevertrt.death.gform,
  cinc.A.death.gform.CIL,cinc.B.death.gform.CIL,cinc.C.death.gform.CIL,cinc.D.death.gform.CIL,cinc.nevertrt.death.gform.CIL,
  cinc.A.death.gform.CIU,cinc.B.death.gform.CIU,cinc.C.death.gform.CIU,cinc.D.death.gform.CIU,cinc.nevertrt.death.gform.CIU
)
...
cols=c("true"="#000000","A"="#D55E00","B"="#009E73","C"="#CC79A7","D"="#56B4E9","nevertrt"="#999999")
...
plot.mace.iptw=ggplot(plot.dta.mace,aes(x=time.grid,y=cinc.A.mace.true))+theme_bw()+
  ...
  addlinetoplot(plot.dta.mace,"time.grid","cinc.nevertrt.mace.true",vcol='"nevertrt"',vlty='"true"')+
  #iptw - estimates
  ...
  addlinetoplot(plot.dta.mace,"time.grid","cinc.nevertrt.mace.iptw",vcol='"nevertrt"',vlty='"other"')+
  #iptw - CIs
  ...
  addribbontoplot(plot.dta.mace,varymin="cinc.nevertrt.mace.iptw.CIL",varymax="cinc.nevertrt.mace.iptw.CIU",vcol="#999999", valpha=0.2)+
  #axes
  scale_x_continuous(breaks=seq(0,5,1),limits=c(0,5))+
  scale_y_continuous(breaks=seq(0,0.5,0.1),limits=c(0,0.5))+
  scale_colour_manual(NULL,values=cols,labels=c(A="Treatment A",B="Treatment B",C="Treatment C",D="Treatment D",D="Never treat"), 
                      breaks=c("A","B","C","D","nevertrt"))+
...
plot.mace.gform=ggplot(plot.dta.mace,aes(x=time.grid,y=cinc.A.mace.true))+theme_bw()+
  ...
  addlinetoplot(plot.dta.mace,"time.grid","cinc.nevertrt.mace.gform",vcol='"nevertrt"',vlty='"other"')+
  #gform - CIs
  ...
  addribbontoplot(plot.dta.mace,varymin="cinc.nevertrt.mace.gform.CIL",varymax="cinc.nevertrt.mace.gform.CIU",vcol="#999999", valpha=0.2)+
  #axes
  scale_x_continuous(breaks=seq(0,5,1),limits=c(0,5))+
  scale_y_continuous(breaks=seq(0,0.5,0.1),limits=c(0,0.5))+
  scale_colour_manual(NULL,values=cols,labels=c(A="Treatment A",B="Treatment B",C="Treatment C",D="Treatment D",D="Never treat"), 
...
plot.mace.naive=ggplot(plot.dta.mace,aes(x=time.grid,y=cinc.A.mace.true))+theme_bw()+
  ...
  addlinetoplot(plot.dta.mace,"time.grid","cinc.nevertrt.mace.naive",vcol='"nevertrt"',vlty='"other"')+
  #naive - CIs
  ...
  addribbontoplot(plot.dta.mace,varymin="cinc.nevertrt.mace.naive.CIL",varymax="cinc.nevertrt.mace.naive.CIU",vcol="#999999", valpha=0.2)+
  #axes
  scale_x_continuous(breaks=seq(0,5,1),limits=c(0,5))+
  scale_y_continuous(breaks=seq(0,0.5,0.1),limits=c(0,0.5))+
  scale_colour_manual(NULL,values=cols,labels=c(A="Treatment A",B="Treatment B",C="Treatment C",D="Treatment D",D="Never treat"), 
...
windows(10,7)
grid.arrange(plot.mace.naive,plot.mace.iptw,plot.mace.gform,ncol=2)
...
plot.death.iptw=ggplot(plot.dta.death,aes(x=time.grid,y=cinc.A.death.true))+theme_bw()+
  ...
  addlinetoplot(plot.dta.death,"time.grid","cinc.nevertrt.death.true",vcol='"nevertrt"',vlty='"true"')+
  #iptw - estimates
  ...
  addlinetoplot(plot.dta.death,"time.grid","cinc.nevertrt.death.iptw",vcol='"nevertrt"',vlty='"other"')+
  #iptw - CIs
  ...
  addribbontoplot(plot.dta.death,varymin="cinc.nevertrt.death.iptw.CIL",varymax="cinc.nevertrt.death.iptw.CIU",vcol="#999999", valpha=0.2)+
  #axes
  scale_x_continuous(breaks=seq(0,5,1),limits=c(0,5))+
  scale_y_continuous(breaks=seq(0,0.5,0.1),limits=c(0,0.5))+
  scale_colour_manual(NULL,values=cols,labels=c(A="Treatment A",B="Treatment B",C="Treatment C",D="Treatment D",D="Never treat"), 
...
plot.death.gform=ggplot(plot.dta.death,aes(x=time.grid,y=cinc.A.death.true))+theme_bw()+
  ...
  addlinetoplot(plot.dta.death,"time.grid","cinc.nevertrt.death.gform",vcol='"nevertrt"',vlty='"other"')+
  #gform - CIs
  ...
  addribbontoplot(plot.dta.death,varymin="cinc.nevertrt.death.gform.CIL",varymax="cinc.nevertrt.death.gform.CIU",vcol="#999999", valpha=0.2)+
  #axes
  scale_x_continuous(breaks=seq(0,5,1),limits=c(0,5))+
  scale_y_continuous(breaks=seq(0,0.5,0.1),limits=c(0,0.5))+
  scale_colour_manual(NULL,values=cols,labels=c(A="Treatment A",B="Treatment B",C="Treatment C",D="Treatment D",D="Never treat"), 
...
plot.death.naive=ggplot(plot.dta.death,aes(x=time.grid,y=cinc.A.death.true))+theme_bw()+
  ...
  addlinetoplot(plot.dta.death,"time.grid","cinc.nevertrt.death.naive",vcol='"nevertrt"',vlty='"other"')+
  #naive - CIs
  ...
  addribbontoplot(plot.dta.death,varymin="cinc.nevertrt.death.naive.CIL",varymax="cinc.nevertrt.death.naive.CIU",vcol="#999999", valpha=0.2)+
  #axes
  scale_x_continuous(breaks=seq(0,5,1),limits=c(0,5))+
  scale_y_continuous(breaks=seq(0,0.5,0.1),limits=c(0,0.5))+
  scale_colour_manual(NULL,values=cols,labels=c(A="Treatment A",B="Treatment B",C="Treatment C",D="Treatment D",D="Never treat"), 
...
windows(10,7)
grid.arrange(plot.death.naive,plot.death.iptw,plot.death.gform,ncol=2)
...
tab.mace5.nevertrt<-rbind(c(tabf2(table.nevertrtta.mace5$cinc.nevertrt.mace.true,table.nevertrtta.mace5$cinc.nevertrt.mace.true.CIL,table.nevertrtta.mace5$cinc.nevertrt.mace.true.CIU)),
                   c(tabf2(table.nevertrtta.mace5$cinc.nevertrt.mace.naive,table.nevertrtta.mace5$cinc.nevertrt.mace.naive.CIL,table.nevertrtta.mace5$cinc.nevertrt.mace.naive.CIU)),
                   c(tabf2(table.nevertrtta.mace5$cinc.nevertrt.mace.iptw,table.nevertrtta.mace5$cinc.nevertrt.mace.iptw.CIL,table.nevertrtta.mace5$cinc.nevertrt.mace.iptw.CIU)),
                   c(tabf2(table.nevertrtta.mace5$cinc.nevertrt.mace.gform,table.nevertrtta.mace5$cinc.nevertrt.mace.gform.CIL,table.nevertrtta.mace5$cinc.nevertrt.mace.gform.CIU)))

tab.mace5<-cbind(tab.mace5.A,tab.mace5.B,tab.mace5.C,tab.mace5.D,tab.mace5.nevertrt)

rownames(tab.mace5)<-c("True","Naive","IPTW","G-formula")
colnames(tab.mace5)<-c("A","B","C","D","Never treat")
...
tab.death5.nevertrt<-rbind(c(tabf2(table.nevertrtta.death5$cinc.nevertrt.death.true,table.nevertrtta.death5$cinc.nevertrt.death.true.CIL,table.nevertrtta.death5$cinc.nevertrt.death.true.CIU)),
                          c(tabf2(table.nevertrtta.death5$cinc.nevertrt.death.naive,table.nevertrtta.death5$cinc.nevertrt.death.naive.CIL,table.nevertrtta.death5$cinc.nevertrt.death.naive.CIU)),
                          c(tabf2(table.nevertrtta.death5$cinc.nevertrt.death.iptw,table.nevertrtta.death5$cinc.nevertrt.death.iptw.CIL,table.nevertrtta.death5$cinc.nevertrt.death.iptw.CIU)),
                          c(tabf2(table.nevertrtta.death5$cinc.nevertrt.death.gform,table.nevertrtta.death5$cinc.nevertrt.death.gform.CIL,table.nevertrtta.death5$cinc.nevertrt.death.gform.CIU)))

tab.death5<-cbind(tab.death5.A,tab.death5.B,tab.death5.C,tab.death5.D,tab.death5.nevertrt)

rownames(tab.death5)<-c("True","Naive","IPTW","G-formula")
colnames(tab.death5)<-c("A","B","C","D","Never treat")
